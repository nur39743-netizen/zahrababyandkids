    ...
    <body class="bg-pink-50 text-gray-800 antialiased min-h-screen flex flex-col font-sans">
        ...
        <div class="fixed bottom-0 left-0 w-full z-50 bg-white border-t border-pink-100 shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
            <div class="max-w-md mx-auto flex justify-around items-center px-2 py-2">
                <a href="/" class="flex flex-col items-center p-2 text-gray-400 hover:text-pink-600 transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                    <span class="text-[10px] mt-1 font-medium">Home</span>
                </a>
                
                <a href="/products" class="flex flex-col items-center p-2 text-gray-400 hover:text-pink-600 transition">
                ...
                <div class="relative -top-5">
                    <a href="/pos" class="flex items-center justify-center w-14 h-14 bg-gradient-to-r from-pink-500 to-rose-400 rounded-full text-white shadow-lg shadow-pink-300 ring-4 ring-pink-50 hover:bg-pink-600 transition transform hover:scale-105">
                ...
                <a href="/categories" class="flex flex-col items-center p-2 text-gray-400 hover:text-pink-600 transition">
                ...
                <a href="/owners" class="flex flex-col items-center p-2 text-gray-400 hover:text-pink-600 transition">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                    <span class="text-[10px] mt-1 font-medium">Owner</span>
                </a>
            </div>
        </div>
