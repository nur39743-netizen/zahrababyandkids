<div>
    <h2 class="text-xl font-bold text-pink-700 mb-4">Manajemen Kategori</h2>
    ...
    <div class="space-y-3">
        ...
        <div class="bg-white p-4 rounded-xl shadow-sm flex justify-between items-center border border-pink-50 hover:shadow-md transition">
            <div>
                <p class="font-bold text-gray-800">{{ $cat->nama_kategori }}</p>
                <p class="text-xs text-gray-400 mt-1"><span class="bg-pink-50 text-pink-600 px-2 py-0.5 rounded-full">{{ $cat->total_produk }} Produk</span></p>
            </div>
