...
class Create extends Component
{
    ...
    public function updated($propertyName)
    {
        ...
        if (in_array($propertyName, ['variant1_id', 'variant2_id', 'has_variant']) || 
    ...
    public function generateMatrix()
    {
        ...
        if(count($opts1) > 0 && count($opts2) > 0) {
            foreach($opts1 as $o1) {
                foreach($opts2 as $o2) {
                    $this->matrix[] = [
                        'v1_id' => $o1, 'v1_val' => $v1s[$o1]->value,
                        'v2_id' => $o2, 'v2_val' => $v2s[$o2]->value,
                        'modal' => 0, 'sell' => 0, 'jual' => 0, 'stok' => 0
                    ];
                }
            }
