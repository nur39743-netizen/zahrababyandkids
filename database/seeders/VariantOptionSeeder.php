...
class VariantOptionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $options = [
            ...
            ['id' => 77, 'attribute_id' => 1, 'value' => 'Merah Marun'],
            ['id' => 78, 'attribute_id' => 1, 'value' => 'Orange Salmon'],
            ['id' => 79, 'attribute_id' => 1, 'value' => 'Biru Soft'],
            ['id' => 80, 'attribute_id' => 1, 'value' => 'Kuning Lemon'],
            ['id' => 81, 'attribute_id' => 1, 'value' => 'Hijau Mint'],
            ['id' => 82, 'attribute_id' => 1, 'value' => 'Ungu Lavender'],
            ['id' => 83, 'attribute_id' => 1, 'value' => 'Abu-abu Silver'],
            ['id' => 84, 'attribute_id' => 1, 'value' => 'Peach'],
            ['id' => 85, 'attribute_id' => 1, 'value' => 'Teal'],
            ['id' => 86, 'attribute_id' => 1, 'value' => 'Mustard'],
            ['id' => 87, 'attribute_id' => 1, 'value' => 'Krim'],
            ['id' => 88, 'attribute_id' => 1, 'value' => 'Charcoal'],
            ['id' => 89, 'attribute_id' => 1, 'value' => 'Navy'],
            ['id' => 90, 'attribute_id' => 1, 'value' => 'Maroon'],
            ['id' => 91, 'attribute_id' => 1, 'value' => 'Salmon'],
            ['id' => 92, 'attribute_id' => 1, 'value' => 'Coral'],
            ['id' => 93, 'attribute_id' => 1, 'value' => 'Khaki'],
            ['id' => 94, 'attribute_id' => 1, 'value' => 'Olive'],
            ['id' => 95, 'attribute_id' => 1, 'value' => 'Plum'],
            ['id' => 96, 'attribute_id' => 1, 'value' => 'Taupe'],
            ['id' => 97, 'attribute_id' => 1, 'value' => 'Rose Gold'],
            ['id' => 98, 'attribute_id' => 1, 'value' => 'Mint Green'],
            ['id' => 99, 'attribute_id' => 1, 'value' => 'Dusty Blue'],
            ['id' => 100, 'attribute_id' => 1, 'value' => 'Sunset Orange'],
            ['id' => 101, 'attribute_id' => 1, 'value' => 'Forest Green'],
            ['id' => 102, 'attribute_id' => 1, 'value' => 'Powder Pink'],
            ['id' => 103, 'attribute_id' => 1, 'value' => 'Stone Gray'],
            ['id' => 104, 'attribute_id' => 1, 'value' => 'Wine Red'],
            ['id' => 105, 'attribute_id' => 1, 'value' => 'Sky Blue'],
